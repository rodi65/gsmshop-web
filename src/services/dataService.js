...
export async function createSale(payload) {
  ...
  // Satış kart/banka tutarı sales.card_amount içinde tutulur.
  // Supabase bank_movements check constraint "Bankaya Giden" tipini kabul etmediği için
  // satış sırasında ayrıca bank_movements kaydı oluşturulmuyor.
  // Günlük kasa raporu kart/banka etkisini sales.card_amount üzerinden okur.
