...
assert(cartPanel.includes("cleanCartProductName"), "Sepet ürün adları UI'da tekrarsız gösterilmeli.");
assert(cartPanel.includes("normalizeCartCategory"), "Sepet kategori etiketi Aksesuar/Telefon gibi normalize edilmeli.");
assert(cartPanel.includes("compact-fill-actions"), "Tamamı nakit/kart/cari aksiyonları kompakt yardımcı satır olmalı.");
