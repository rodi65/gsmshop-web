...
assert(style.includes("Kasa dashboard final yerleşim") && style.includes("Kasa özet kartları görünürlük düzeltmesi") && style.includes("Kasa yatay butonlar ve uzun Kart/Cari kartı") && style.includes("Kasa yatay buton tekrarı") && style.includes("grid-template-rows: 176px minmax(350px, auto)") && style.includes("flex: 0 0 145px"), "Ana Kasa dashboard butonları yatay okunur ve Kart/Cari kartı daha uzun kalmalı.");
