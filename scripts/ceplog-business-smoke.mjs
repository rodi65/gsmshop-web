...
assert(style.includes("Final gap-only override") && style.includes("margin-block-end: 0 !important") && style.includes("translate: 0 -2px !important"), "Sepet ürün/toplam arası final boşluk override korunmalı.");
