...
assert(cartPanel.includes("cleanCartProductName"), "Sepet ürün adları tekrarlı görünmemesi için temizlenmeli.");
assert(cartPanel.includes("cart-payment-quick-fill"), "Tamamı nakit/kart/cari aksiyonları ikincil hızlı doldur satırı olmalı.");
