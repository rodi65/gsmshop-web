...
assert(style.includes("Final zero vertical gap") && style.includes("grid-auto-rows: max-content") && style.includes("cart-checkout-list + .cart-final-summary"), "Sepet ürün listesi ile toplam/ödeme blokları final sıfır boşluk kuralına sahip olmalı.");
