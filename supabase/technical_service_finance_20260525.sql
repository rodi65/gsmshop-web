-- CEPLOG Teknik Servis finans hareketleri
-- Bu dosyayi Supabase SQL Editor'da manuel calistirin.
-- Mevcut verileri silmez, tablo drop etmez.

alter table public.cash_movements add column if not exists related_service_id text;
alter table public.cash_movements add column if not exists service_record_id text;
...
alter table public.bank_movements add column if not exists direction text;
alter table public.bank_movements add column if not exists related_table text;
alter table public.bank_movements add column if not exists related_id text;
alter table public.bank_movements add column if not exists related_service_id text;
alter table public.bank_movements add column if not exists service_record_id text;
alter table public.bank_movements add column if not exists status text;
